...
class TextureBatch(
    ...
    ShaderProgram(
        VertexShader(
            TextureRenderer::class.java.getResourceAsStream("/assets/shader/texture/vert.glsl")!!.readBytes()
                .decodeToString()
        ),
        FragmentShader(
            TextureRenderer::class.java.getResourceAsStream("/assets/shader/texture/frag.glsl")!!.readBytes()
                .decodeToString()
        )
    ),
    GL_TRIANGLES,
